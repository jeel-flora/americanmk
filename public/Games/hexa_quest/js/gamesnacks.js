    ...
    var a, r = {
        ...
        E = function(e) {
            ...
            this.environment = "production", this.audioEnabled = !0, this.shouldAudioBeEnabledAfterAd = !0, this.isAdInProgress = !1, this.audioSubscribers = [], this.ghostDataSubscriber = null, this.adsInitialized = !1, this.rewardedAdsAllowed = !1, this.rewardedAdName = "", this.forceVerbose = !1, this.sendScore = function(e, n) {
                ...
                t.environment = "test", t._logIfVerbose("GameSnacks SDK is running in a test environment."), t._initializeAdsWithValidatedConfig(r), t._handleRewardedAdsAllowed(o), t.postMessageHandler.send({
                    ...
                    var n = t,
                        a = {
                            ...
                            beforeReward: function(t) {
                                n._logIfVerbose("AFG called beforeReward"), e.beforeReward((function() {
            ...
            }, this.postMessageHandler = e, this._checkEnvironmentAttribute(), this.listenAndDelegateMessages(), this._sendSdkLoadedMessage()
        },
        g = function() {
            function e() {
