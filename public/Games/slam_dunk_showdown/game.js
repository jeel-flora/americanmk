/*! game-api - v0.35.18 - 2017-01-19 */ ! function(a) {
    "use strict";

    function b(a) {
        a = a || {}, this.advertisement = a.advertisement, this.newTabCap = !1, this.NEW_TAB_CAP_TIME = 500
    }
    ...
    function u(a, d, n, p, q) {
        ...
        this.version = "0.35.18", this.isReady = !1, this._setRole(), this.__ = {}, this.__.dataStore = this.IS_MASTER ? new a({
            isMaster: !0
    ...
    "bind" in Function.prototype || (Function.prototype.bind = function(a) {
        ...
        for (void 0 === b && (b = this.length - 1), b < 0 && (b += this.length), b > this.length - 1 && (b = this.length - 1), b++; b-- > 0;)
            if (b in this && this[b] === a) return b;
        return -1
    ...
    v.getGameConfig = function(a) {
        ...
        var d = setTimeout(function() {
            ...
            h = a.portal.applicationId,
            i = "en-EN",
            j = [e, g, f, h].join("/");
        navigator && "undefined" != typeof navigator && ("undefined" != typeof navigator.languages && "undefined" != typeof navigator.languages[0] ? i = navigator.languages[0] : "undefined" != typeof navigator.userLanguage && (i = navigator.userLanguage)), j = j + "?locale=" + i, SpilGames(["Net", "JSLib"], function(e, f) {
            e.send({
                url: j,
                type: "GET",
                dataType: "JSON"
                ...
                if (!c) {
                    ...
                    if (e && e.configar) clearTimeout(d), window.postMessage(new r({
                        type: "success",
                        callbackId: null,
    ...
    w.argsToArray = function(a) {
        ...
        try {
            if ("www8.agame.com" === window.location.host) {
                ...
                a(window, document, "script", "//www.google-analytics.com/analytics.js", "ga"), ga("create", "UA-8223336-3", "auto"), ga("send", "pageview")
            }
        } catch (b) {}
        ...
        var c, d, e = a.site || 500,
            f = a.channel || 100,
            g = a.id || null;
        window.XDomainRequest ? (c = new XDomainRequest, c.onload = function() {
            ...
            4 === c.readyState && b(c.status, c.responseText)
        }), g && (d = ["./configs", f, e, g].join("/"), c.open("GET", d, !0), c.timeout = 3e3, c.ontimeout = function() {
            b(404, null)
        }, c.send())
        ...
        var d, e = a || "",
            f = b || {},
            g = c || function() {};
        window.XDomainRequest ? (d = new XDomainRequest, d.onload = function() {
            g(200, d.responseText)
        }, d.onerror = function() {
            g(404, null)
        }, d.onprogress = function() {}, d.open("POST", e, !0)) : window.XMLHttpRequest ? (navigator.userAgent.match(/Trident\/7.0;.* rv:11/) ? d = this.getJSONP() : (d = new XMLHttpRequest, d.onreadystatechange = function(a) {
            4 === d.readyState && g(d.status, d.responseText)
        }), d.open("POST", e, !0), d.setRequestHeader("Content-type", "application/x-www-form-urlencoded")) : window.ActiveXObject && (d = new ActiveXObject("Microsoft.XMLHTTP"), d.onreadystatechange = function(a) {
            4 === d.readyState && g(d.status, d.responseText)
        }, d.open("POST", e, !0)), d.timeout = 3e3, d.ontimeout = function() {
            g(404, null)
        ...
        var c, d, e = a.url || "",
            ...
            j = void 0 === a.async || a.async;
        if (XMLHttpRequest) {
            if (c = new XMLHttpRequest, "withCredentials" in c) {
                c.open(f, e, j), c.onerror = i, c.onreadystatechange = function() {
                    4 === c.readyState && b(c.status >= 200 && c.status < 400 ? {
                        data: c.responseText,
                        status: c.status
                    } : {
                        isError: !0,
            ...
            c = new XDomainRequest, c.open(f, e), c.onerror = i, c.onload = function() {
                b(c.responseText)
            };
            for (d in h) h.hasOwnProperty(d) && c.setRequestHeader(d, h[d]);
            c.send(g)
    ...
    }, w.isArray = Array.isArray || function(a) {
        ...
        var b = {};
        return "string" == typeof a && a.replace(/[?&]+([^=&]+)=([^&]*)/gi, function(a, c, d) {
            b[c] = d
        }), b
        ...
        for (var c in b)
            if (b.hasOwnProperty(c)) {
                if (!a.hasOwnProperty(c)) return {
                    error: "Wrong argument passed: " + c
                };
                if (a.hasOwnProperty(c)) {
                    var d = "object" == typeof a[c] ? a[c].type : a[c];
                    if (b[c].constructor.name !== d) return {
                        error: "Wrong value type for " + c + ": expected " + a[c] + ", got " + b[c].constructor.name
                    };
                    var e = a[c] && a[c].values || [];
                    if (e.indexOf(b[c]) === -1) return {
                        error: "Wrong value for " + c + ": expected " + e.join(" or ") + ", got " + b[c]
                    }
                }
            }
        return {
    ...
    x.__ = {}, x.__.user = function() {
        ...
        c.JSLib = {
            ...
            if (a[0] && "string" == typeof a[0]) c.JSLib.publish(a[0], a[1] || null);
                ...
                var b, d, e = [];
                for (b = 0, d = a[0].length; b < d; b++) e.push(c[a[0][b]]);
                a[1].apply(this, e)
            }
        ...
        return b.style.left = "0", b.style.top = "0", b.style.width = f + "px", b.style.height = g + "px", b.style.position = "absolute", b.style.zIndex = "10000", b.onclick = d, c && (b.style.background = "url('" + c + "') center center no-repeat #FFF"), window.setTimeout(function() {
        ...
        f.type = "text/css", f.innerHTML = d.getDisplayBannerCss(), d.spilgames_crosspromotion_banner_container = document.createElement("div"), d.spilgames_crosspromotion_banner_container.appendChild(f), d.spilgames_crosspromotion_banner_container.id = "spilgames_crosspromotion_banner", d.spilgames_crosspromotion_banner_container.setAttribute("style", this.getDisplayBannerCss().spilgames_crosspromotion_banner), d.spilgames_crosspromotion_banner_container.innerHTML = d.getDisplayBannerHTML(), document.body.insertBefore(d.spilgames_crosspromotion_banner_container, document.body.childNodes[0]);
        ...
        d.closeBanner = function() {
            d.spilgames_crosspromotion_banner_container.style.opacity = 0, setTimeout(function() {
            ...
            }, 500), window.clearTimeout(d.closeTimeOut)
        ...
        function b() {
            ...
            this.advertisement.createDFP({
                adUnitPath: "/" + this.advertisement.defaultAdUnitId + "/offportal",
                size: [300, 250],
                opt_div: b
            }), googletag.cmd.push(function() {
                googletag.pubads().addEventListener("slotRenderEnded", function(c) {
                    c && c.slot && !c.isEmpty && c.slot.getSlotElementId() === b && (a.spilgames_crosspromotion_banner_container.style.display = "block", setTimeout(function() {
                        a.spilgames_crosspromotion_banner_container.style.opacity = 1
                    }, 0), a.closeTimeOut = setTimeout(a.closeBanner, 1e4))
                })
            })
        }
        ...
        var a = {
            spil_crosspromotion_closebtn: "position:absolute;right:0;top:0px;",
            gptContainer: "width:300px;height:250px;margin:25px auto;position:relative;box-shadow:0 0 4px 2px rgba(0,0,0,0.5);background:#000;",
            spilgames_crosspromotion_banner: "width:100%;height:100%;overflow:hidden;position:absolute;opacity:0;display:none;z-index:99999;transition:opacity .5s;background:rgba(0, 0, 0, 1);"
        };
        return a
    }, b.prototype.getDisplayBannerHTML = function() {
        var a = '<div id="gptContainer" style="' + this.getDisplayBannerCss().gptContainer + '"><div id="banner-content"></div><img id="closebanner" class="spil_crosspromotion_closebtn" style="' + this.getDisplayBannerCss().spil_crosspromotion_closebtn + '" src="./1448551529_close.png"/></div>';
        return a
        ...
        return "/" + this.defaultAdUnitId + "/" + this.defaultAdUnitPath + "/" + this.data.game.applicationId + "/0_GP_300x250_F012_ATF_R0_T000_D000_P000_B000"
        ...
        var b = this;
        if (a.adUnitPath = a.adUnitPath || this.getDefaultAdUnitPath(), void 0 === window.googletag) {
            window.googletag = window.googletag || {}, googletag.cmd = googletag.cmd || [];
            var c = document.createElement("script");
            c.src = "./gpt.js", document.body.insertBefore(c, document.body.childNodes[0])
        }
        void 0 !== b.adSlots[a.opt_div] ? b.refreshAdSlot(a.opt_div) : googletag.cmd.push(function() {
            var c = b.data.portal.host;
            "8c2bdb8db92f43c6851e4c3bf280e0e7.cloudapp.net" !== c && "www.noradsanta.org" !== c && "a10.com" !== c && "stg.a10.com" !== c || (c = c.replace(".", " ")), b.adSlots[a.opt_div] = googletag.defineSlot(a.adUnitPath, a.size, a.opt_div).addService(googletag.pubads()).setTargeting("GameID", b.data.game.applicationId).setTargeting("HostName", c), googletag.enableServices(), googletag.display(a.opt_div)
        })
    }, c.prototype.refreshAdSlot = function(a) {
        "undefined" != typeof googletag && "function" == typeof googletag.pubads && googletag.pubads().refresh([this.adSlots[a]])
        ...
        c.isValid || console.log("AD Size for " + a + " is not valid, switching to default size: " + c.size), this.createDFP({
            opt_div: a,
            size: c.size
        })
    }, c.prototype.parseDOMForAds = function() {
        for (var a = document.querySelectorAll("[data-spil-games-ph]"), b = this, c = function(c) {
        ...
        this.IS_MASTER || this.messenger._postMessage({}, void 0, "gameapi.apptoken.getAppToken"), this.IS_MASTER && ("function" == typeof SpilGames ? SpilGames("api.account.getApplicationToken", w.addToken(this.token, {
            cache: !1,
            applicationId: this.appId
        }), function(c) {
            c.error || !c.appAuth.token ? a._postMessage({}, void 0, "gameapi.apptoken.getAppTokenResponse") : (b.appToken = c.appAuth.token, a._postMessage({
                appToken: c.appAuth.token,
                level: c.level
        ...
        a = a || {}, this.data = a.data || this.data, this.data && this.data.game && this.data.user && this.data.portal && (this.gameState.appId = this.data.game.applicationId || null, this.gameState.userId = this.data.user.userId || null, this.isGamestate = this.data.portal.gamestate || !1, this.endpoint = w.getServiceEndpoint(this.data.portal.env), this.spilStorageId = this.data.portal.spilStorageId), this.isGamestate && (this.IS_SLAVE || this.IS_STANDALONE || w.isWrapped()) && (this.listenStorageEvents(), this.preloadGameState())
        ...
        for (var a, b = this.gameState.appId, c = this.gameState.userId, d = this.gameState.dirtyKeys, e = {
                set: {},
                remove: []
            }, f = 0, g = this, h = 0; h < d.length; h++) a = window.localStorage[d[h]], void 0 === a ? e.remove.push(d[h]) : (e.set[d[h]] = a, f = Math.max(a.length, f));
        if (d.length > 0) {
            var i = {
                url: this.endpoint + "/v1/gamestate/" + c + "/" + b,
                type: "POST",
        ...
        var b = new r(a.data || {}),
            c = this.messenger,
            d = this.subscribers || {};
        if (b && b.type && b.data) switch (b.type) {
            case "gameEvent":
                b.data[0] && d[b.data[0]] && d[b.data[0]].length > 0 ? d[b.data[0]].forEach(function(a) {
                    a.call(this), c._postMessage([b.data[0], {
                            origin: "slave"
                        },
                        null
                    ], null, "gameState")
                }) : b.data[0] && b.data[1] && "slave" === b.data[1].origin && "function" == typeof SWFtoJS && SWFtoJS({
                    call: b.data[0],
                    params: {}
                });
                break;
        ...
        var a = !1;
        if (!this.moduleReady) throw new Error("This method cannot be called before the API is loaded");
        var b = w.getVariablesFromUrl(window.location.href);
        return "undefined" != typeof this.data && "undefined" != typeof this.data.portal && "undefined" != typeof this.data.portal.siteId && typeof this.data.portal.siteId < 0 && ("undefined" == typeof b || "undefined" == typeof b.siteid || "undefined" == typeof b.channelid) && (a = !0), a
        ...
        if (a = a || {}, this.logincallback = b, this.IS_MASTER) SpilGames("api.auth.getToken", {
            context: {
                channelid: 100,
                siteid: 2
            }
        ...
        if (!this.moduleReady) throw new Error("This method cannot be called before the API is loaded");
        this.IS_MASTER ? "function" == typeof SpilGames && "undefined" != typeof SpilGames.Portal && "function" == typeof SpilGames.Portal.forceAuthentication && SpilGames.Portal.forceAuthentication({
            onsuccess: function() {}
        ...
        if (!this.moduleReady) throw new Error("This method cannot be called before the API is loaded");
        if (this.IS_MASTER) "function" == typeof SpilGames ? this.isAvailable ? SpilGames(["JSLib"], function(a) {
            a && "function" == typeof a ? a("api.user.getExtended", function(a) {
            ...
            userInfoExtended: {}
        }, void 0, "gameapi.user.getUserResponse") : b._postMessage({
            userInfoExtended: {}
        }, void 0, "gameapi.user.getUserResponse");
        else {
            if ("function" != typeof a) throw new Error("The argument passed to the GameAPI.User.getUser method should be a function");
            this.usercallback = a, b._postMessage({}, void 0, "gameapi.user.getUser"), b._postMessage(["log.gameapi.user.getUser", {
                    origin: "slave",
                    argumentType: typeof a
                },
                null
            ], null, "log")
        }
        ...
        var b = a.userInfoExtended || {},
            ...
            d = !1;
        "" === b.guid && (d = !0), this.eventTracking.trackGameAPIEvent("userGet", {
            guid: c.guid || "",
            fail: d
        }), this.usercallback(c)
        ...
        var b = {
            ...
            guid: a.guid || "",
            displayName: a.name || "",
            pic_square: a.avatarUrl || "",
            pic_square_large: a.avatarLargeUrl || "",
            gender: a.gender || "",
            age: a.age || "",
        ...
        if (this.IS_MASTER) {
            if ("function" == typeof SpilGames) {
                ...
                SpilGames(["JSLib"], function(a) {
                    a && "function" == typeof a ? a("api.user.getExtended", function(a) {
                        a.userInfoExtended && "guest" !== a.userInfoExtended.name && a.userInfoExtended.guid ? (this.userGuid = a.userInfoExtended.guid, c._getFriendsFromPortal([], 1)) : b._postMessage({
                            friendList: {}
        ...
        } else "function" == typeof a && (this.friendscallback = a), b._postMessage({}, void 0, "gameapi.friends.getFriends"), b._postMessage(["log.gameapi.friends.getFriends", {
                origin: "slave"
            },
            null
        ], null, "log")
        ...
        if ("function" == typeof SpilGames) {
            ...
            SpilGames("api.friend.list", {
                ...
                a.error ? c._postMessage(d, void 0, "gameapi.friends.getFriendsResponse") : (d = d.concat(a.friendList), a.pageControl && a.pageControl.totalPages > b ? e._getFriendsFromPortal(d, b + 1) : c._postMessage({
                    friendList: d
                }, void 0, "gameapi.friends.getFriendsResponse"))
            })
        } else c._postMessage({
        ...
        var b = this._validateData(a.friendList),
            c = !1;
        0 === b.length && (c = !0), this.eventTracking.trackGameAPIEvent("friendsGet", {
            guid: this.guid || "",
            fail: c
        }), this.friendscallback(b)
        ...
        for (var b = [], c = 0; c < a.length; c++) {
            var d = {
                ...
                pic_square: a[c].avatarUrl || "",
                pic_square_large: a[c].avatarLargeUrl || "",
                gender: a[c].gender || "",
                age: a[c].age || ""
            };
            b.push(d)
        ...
        var b = this;
        a = a || {}, this.data = a.data || this.data, this.data && this.data.user && this.data.user.userId ? this.state.userId = this.data.user.userId : "function" == typeof SpilGames && SpilGames("api.user.get", function(a) {
            b.state.userId = a.userInfo.guid || null
        })
        ...
        return c._callbacks.pause = a, c._callbacks.resume = b, this.gamebreakType = "reward", this.isMaster ? void c._runCallback("resume", {
            ...
            null
        ], null, "log"), this.eventTracking.trackGameAPIEvent("gamebreakRequest", {
        ...
        this.isMaster || b._postMessage(["log.gameapi.ad.complete", {
            ...
            null
        ], null, "log"), this.eventTracking.trackGameAPIEvent("gamebreakComplete", {
        ...
        var b = this.gamePlayTracking.appid,
            ...
            e = this._createEventObject("game", "gameplay", {
                applicationId: b,
                apiuid: String(this.gameAPIUserId),
                apisid: String(this.sessionId),
                start: c,
                host: d
            }),
            f = this.data.isLocal,
        ...
        var j = this._createEventObject("gameapi", "load", {
            siteid: h,
            appid: b,
            channelid: i,
            apiuid: String(this.gameAPIUserId),
        ...
        var b = this.timeInGameTracking.appid,
            ...
            d = this._createEventObject("game", "heartbeat", {
                applicationId: b,
                apiuid: String(this.gameAPIUserId),
                apisid: String(this.sessionId),
                start: c
        ...
        return a ? (this.gamePlayTracking.appid = a, this.gamePlayTracking.timestamp = Date.parse(b), this.gamePlayTracking.host = c, this.timeInGameTracking.appid = a, void(this.timeInGameTracking.timestamp = Date.parse(b))) : {
        ...
        return this.moduleReady ? this.gamePlayTracking.appid ? (this.gamePlayTracking.started = !0, this.timeInGameTracking.started = !0, this.trackGamePlay(function(a) {
            if (!a) throw "Could not save the game play"
        }), this.trackTimeInGame(c), setInterval(function() {
            a.trackTimeInGame(c)
        }, b), this.gamePlayTracking.started && this.timeInGameTracking.started) : {
            error: "No application ID defined for this game"
        } : {
        ...
        var b;
        a = a || {}, this.data = a.data || this.data, this.data && this.data.portal && this.data.portal.siteId && 187 !== this.data.portal.siteId && (b = this.data.portal.siteId, b && this.data.branding && this.data.branding.more_games && this.data.branding.more_games.handler && "moreGames" !== this.data.branding.more_games.handler && (this.data.branding.more_games.handler = "moreGames")), this.IS_SLAVE && !this.IS_STANDALONE ? this.data && this.data.portal && this.data.portal.siteId && this.data.portal.siteId < 500 && this.data.portal.siteId > 0 ? this._displaySpilBanner({
            onportal: !0
        }) : this._displaySpilBanner({
            onportal: !1
        }) : this.IS_STANDALONE && this._displaySpilBanner({
            onportal: !1
        })
        ...
        var a, b = this.IS_MASTER ? "master" : "slave";
        if (this.data && this.data.branding && this.data.branding.splash_screen) {
            var c = !0;
            this.data.branding.splash_screen.image || this.data.branding.splash_screen.url || (c = !1), a = {
                show: c,
        ...
        a = a || {};
        var b = a.onportal || !1;
        b || this.components.displayDFPBanner({
            eventTracking: this.eventTracking
        })
    }, q.prototype._tagUrl = function(a, b) {
        var c, d, e, f = this.data && this.data.portal ? this.data.portal : {},
            g = this.data && this.data.game ? this.data.game : {},
            h = parseInt(f.siteId, 10);
        if ("string" != typeof a) throw new Error("No url specified");
        return c = "string" == typeof b ? b : "logo", d = "brandedgames_" + (h > 0 && h < 500 ? "internal" : "external"), e = ["utm_medium=" + d, "utm_campaign=" + g.applicationId, "utm_source=" + f.host, "utm_content=" + c].join("&"), a += a.indexOf("?") > -1 ? "&" : "?", a + e
        ...
        var d, e;
        d = w.isArray(a) && "function" == typeof a[a.length - 1] ? this._callbacks.push(a.pop()) - 1 : b, e = new r({
            type: c || "jslib",
            callbackId: d,
            data: a
        }).encode();
        ...
        var b, c, d, e, f = this,
            g = new r(a.data);
        if (g)
            if (b = g.type, c = g.callbackId, d = g.data, e = this._callbacks[c] || !1, this.IS_MASTER) switch (b) {
                case "jslib":
        ...
        var b = ["576742227280298306", "576742227280299831", "576742227280296759"];
        if (this.IS_STANDALONE && "undefined" != typeof a && "undefined" != typeof a.game && "undefined" != typeof a.game.applicationId && b.indexOf(a.game.applicationId) >= 0) {
            var c = w.getVariablesFromUrl(window.location.href);
            if ("undefined" == typeof c || "undefined" == typeof c.siteid || "undefined" == typeof c.channelid) {
                var d = "./embed/" + a.game.applicationId + "/?ref=" + a.portal.host;
        ...
        return !0 === this.isReady ? (w.log("WARNING: Detected multiple executions of GameAPI.loadAPI(). This method should only be executed once per page load!"), a(l)) : (this.__.messenger._postMessage(["log.gameapi.loadapi.start", {
            ...
            null
        ], null, "log"), void(this.IS_STANDALONE ? g() : this.IS_MASTER ? x.getGameConfig(j) : b && b.gamestate ? c(x.configFromData(b)) : (k = setTimeout(g, 600), h())))
    };
