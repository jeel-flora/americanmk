                    ...
                    if (i !== null) {
                        for (var n = 0, s = i; n < s.length; n++) {
                            ...
                            switch (o.type) {
                                case 30:
                                    {
                                        var l = t.BaseObject.borrowObject(t.IKConstraintTimelineState);l.target = r;l.init(this._armature, this, o);this._constraintTimelines.push(l);
                                        break
                                    }
                                default:
                                    break
                        ...
                        if (_ !== null) {
                            for (var p = 0, c = _; p < c.length; p++) {
                                ...
                                switch (d.type) {
                                    case 10:
                                        {
                                            var n = t.BaseObject.borrowObject(t.BoneAllTimelineState);n.target = m;n.init(this._armature, this, d);this._boneTimelines.push(n);
                                            break
                                        }
                                    case 11:
                                        {
                                            var n = t.BaseObject.borrowObject(t.BoneTranslateTimelineState);n.target = m;n.init(this._armature, this, d);this._boneTimelines.push(n);
                                            break
                                        }
                                    case 12:
                                        {
                                            var n = t.BaseObject.borrowObject(t.BoneRotateTimelineState);n.target = m;n.init(this._armature, this, d);this._boneTimelines.push(n);
                                            break
                                        }
                                    case 13:
                                        {
                                            var n = t.BaseObject.borrowObject(t.BoneScaleTimelineState);n.target = m;n.init(this._armature, this, d);this._boneTimelines.push(n);
                                            break
                                        }
                                    case 60:
                                        {
                                            var n = t.BaseObject.borrowObject(t.AlphaTimelineState);n.target = this._armature.animation.getBlendState(a.BONE_ALPHA, f.name, f);n.init(this._armature, this, d);this._boneBlendTimelines.push(n);
                                            break
                                        }
                                    case 50:
                                        {
                                            var n = t.BaseObject.borrowObject(t.SurfaceTimelineState);n.target = this._armature.animation.getBlendState(a.SURFACE, f.name, f);n.init(this._armature, this, d);this._boneBlendTimelines.push(n);
                                            break
                                        }
                                    default:
                                        break
                        ...
                        if (_ !== null) {
                            for (var C = 0, w = _; C < w.length; C++) {
                                ...
                                switch (d.type) {
                                    case 20:
                                        {
                                            var n = t.BaseObject.borrowObject(t.SlotDislayTimelineState);n.target = E;n.init(this._armature, this, d);this._slotTimelines.push(n);I = true;
                                            break
                                        }
                                    case 23:
                                        {
                                            var n = t.BaseObject.borrowObject(t.SlotZIndexTimelineState);n.target = this._armature.animation.getBlendState(a.SLOT_Z_INDEX, E.name, E);n.init(this._armature, this, d);this._slotBlendTimelines.push(n);
                                            break
                                        }
                                    case 21:
                                        {
                                            var n = t.BaseObject.borrowObject(t.SlotColorTimelineState);n.target = E;n.init(this._armature, this, d);this._slotTimelines.push(n);F = true;
                                            break
                                        }
                                    case 22:
                                        {
                                            var n = t.BaseObject.borrowObject(t.DeformTimelineState);n.target = this._armature.animation.getBlendState(a.SLOT_DEFORM, E.name, E);n.init(this._armature, this, d);
                                            if (n.target !== null) {
                                    ...
                                    case 24:
                                        {
                                            var n = t.BaseObject.borrowObject(t.AlphaTimelineState);n.target = this._armature.animation.getBlendState(a.SLOT_ALPHA, E.name, E);n.init(this._armature, this, d);this._slotBlendTimelines.push(n);
                                            break
                                        }
                                    default:
                                        break
            ...
            if (a !== null) {
                for (var r = 0, i = a; r < i.length; r++) {
                    ...
                    switch (n.type) {
                        case 40:
                            {
                                var s = t.BaseObject.borrowObject(t.AnimationProgressTimelineState);s.target = e;s.init(this._armature, this, n);this._animationTimelines.push(s);
                                if (this.blendType !== 0) {
                                    var o = n;
                                    e.positionX = o.x;
                                    e.positionY = o.y;
                                ...
                                e._parent = this;this.resetToPose = false;
                                break
                            }
                        case 41:
                            {
                                var s = t.BaseObject.borrowObject(t.AnimationWeightTimelineState);s.target = e;s.init(this._armature, this, n);this._animationTimelines.push(s);
                                break
                            }
                        case 42:
                            {
                                var s = t.BaseObject.borrowObject(t.AnimationParametersTimelineState);s.target = e;s.init(this._armature, this, n);this._animationTimelines.push(s);
                                break
                            }
                        default:
                            break
    ...
    var e = function(e) {
        ...
        r.prototype._parseArmature = function(e, a) {
            ...
            if (t.DataParser.ANIMATION in e) {
                var X = e[t.DataParser.ANIMATION];
                for (var G = 0, H = X; G < H.length; G++) {
                    var z = H[G];
        ...
        r.prototype._parseDisplay = function(e) {
            ...
            switch (n) {
                case 0:
                    {
                        var o = s = t.BaseObject.borrowObject(t.ImageDisplayData);o.name = a;o.path = i.length > 0 ? i : a;this._parsePivot(e, o);
                        break
                    }
                case 1:
                    {
                        var l = s = t.BaseObject.borrowObject(t.ArmatureDisplayData);l.name = a;l.path = i.length > 0 ? i : a;l.inheritAnimation = true;
                        if (t.DataParser.ACTIONS in e) {
                ...
                case 2:
                    {
                        var d = s = t.BaseObject.borrowObject(t.MeshDisplayData);d.geometry.inheritDeform = r._getBoolean(e, t.DataParser.INHERIT_DEFORM, true);d.name = a;d.path = i.length > 0 ? i : a;
                ...
                case 4:
                    {
                        ...
                        var D = s = t.BaseObject.borrowObject(t.PathDisplayData);D.closed = r._getBoolean(e, t.DataParser.CLOSED, false);D.constantSpeed = r._getBoolean(e, t.DataParser.CONSTANT_SPEED, false);D.name = a;D.path = i.length > 0 ? i : a;D.curveLengths.length = g.length;
                        ...
                        case 50:
                            {
                                ...
                                this._geometry = M.geometry;D = this._parseTimeline(_, null, t.DataParser.FRAME, x, 2, 0, this._parseDeformFrame);this._geometry = null;
                                break
                            }
                        case 22:
                            {
                                ...
                                D = this._parseTimeline(_, null, t.DataParser.FRAME, x, 2, 0, this._parseDeformFrame);this._geometry = null;
                                break
                            }
                        case 21:
        ...
        r.prototype._parseSingleValueFrame = function(e, a, i) {
            ...
            switch (this._frameValueType) {
                case 0:
                    {
                        n = this._parseFrame(e, a, i);this._frameArray.length += 1;this._frameArray[n + 1] = r._getNumber(e, t.DataParser.VALUE, this._frameDefaultValue);
                        break
                    }
                case 1:
                    {
                        n = this._parseTweenFrame(e, a, i);
                        var s = this._frameIntArray.length;this._frameIntArray.length += 1;this._frameIntArray[s] = Math.round(r._getNumber(e, t.DataParser.VALUE, this._frameDefaultValue) * this._frameValueScale);
                        break
                    }
                case 2:
                    {
                        n = this._parseTweenFrame(e, a, i);
                        var s = this._frameFloatArray.length;this._frameFloatArray.length += 1;this._frameFloatArray[s] = r._getNumber(e, t.DataParser.VALUE, this._frameDefaultValue) * this._frameValueScale;
                        break
                    }
            }
            return n
        ...
        r.prototype._parseDoubleValueFrame = function(e, a, i) {
            ...
            switch (this._frameValueType) {
                case 0:
                    {
                        n = this._parseFrame(e, a, i);this._frameArray.length += 2;this._frameArray[n + 1] = r._getNumber(e, t.DataParser.X, this._frameDefaultValue);this._frameArray[n + 2] = r._getNumber(e, t.DataParser.Y, this._frameDefaultValue);
                        break
                    }
                case 1:
                    {
                        n = this._parseTweenFrame(e, a, i);
                        var s = this._frameIntArray.length;this._frameIntArray.length += 2;this._frameIntArray[s] = Math.round(r._getNumber(e, t.DataParser.X, this._frameDefaultValue) * this._frameValueScale);this._frameIntArray[s + 1] = Math.round(r._getNumber(e, t.DataParser.Y, this._frameDefaultValue) * this._frameValueScale);
                        break
                    }
                case 2:
                    {
                        n = this._parseTweenFrame(e, a, i);
                        var s = this._frameFloatArray.length;this._frameFloatArray.length += 2;this._frameFloatArray[s] = r._getNumber(e, t.DataParser.X, this._frameDefaultValue) * this._frameValueScale;this._frameFloatArray[s + 1] = r._getNumber(e, t.DataParser.Y, this._frameDefaultValue) * this._frameValueScale;
                        break
                    }
            }
            return n
            ...
            set: function(t) {
                ...
                if (this._renderTexture !== null) {
                    for (var e in this.textures) {
                        ...
                        a.renderTexture = new PIXI.Texture(this._renderTexture, a.region, a.region, new PIXI.Rectangle(0, 0, a.region.width, a.region.height))
                    }
                } else {
                    for (var e in this.textures) {
                        var a = this.textures[e];
...
(function(t) {
    var e = function(e) {
        ...
        function a() {
            var a = e.call(this, t.PhaserFactory._game, 0, 0) || this;
            a.debugDraw = false;
            a._debugDraw = false;
            a._armature = null;
            a._signals = {};
        ...
        a.prototype._getChildByName = function(t, e) {
            for (var a = 0, r = t.children; a < r.length; a++) {
                var i = r[a];
                if (i.name === e) {
                    return i
                }
            ...
            if (e || this._debugDraw) {
                ...
                if (this._debugDraw) {
                    if (this._debugDrawer === null) {
                        ...
                        var a = new Phaser.Graphics(this.game);
                    ...
                    for (var n = 0, s = m.length; n < s; ++n) {
                        ...
                        if (c) {
                            var d = this._getChildByName(this._debugDrawer, p.name);
                            if (!d) {
                                d = new Phaser.Graphics(this.game);
                                d.name = p.name;
        ...
        a.prototype.addEvent = function(t, e, a) {
            this.addDBEventListener(t, e, a)
        };
        a.prototype.removeEvent = function(t, e, a) {
    ...
    var e = function(e) {
        ...
        a.prototype.updateTransform = function(e) {
            ...
            if (this.rotation % Phaser.Math.PI2) {
                ...
                i.c = o * r.a + l * r.c;
                i.d = o * r.b + l * r.d;
                i.tx = h * r.a + u * r.c + r.tx;
                i.ty = h * r.b + u * r.d + r.ty
            } else {
                n = this.scale.x;
                s = 0;
                o = 0;
            ...
            this.worldAlpha = this.alpha * a.worldAlpha;
            this.worldPosition.x = i.tx;
            this.worldPosition.y = i.ty;
            this._currentBounds = null;
            if (this.transformCallback) {
                this.transformCallback.call(this.transformCallbackContext, i, r)
            }
            return this
        };
        return a
    }(Phaser.Image);
    t.PhaserSlotDisplay = e
})(dragonBones || (dragonBones = {}));
var dragonBones;
(function(t) {
    var e = function(e) {
        ...
        a.init = function(e) {
            ...
            a._game = e;
            var r = new t.PhaserArmatureDisplay;
            a._dragonBonesInstance = new t.DragonBones(r)
        };
        ...
        a.prototype._buildSlot = function(e, r, i) {
            e;
            i;
            var n = t.BaseObject.borrowObject(t.PhaserSlot);
            var s = new t.PhaserSlotDisplay(a._game, 0, 0, Phaser.Cache.DEFAULT);
            n.init(r, i, s, s);
            return n
        };
        ...
        a.prototype.getTextureDisplay = function(t, e) {
            ...
            var r = this._getTextureData(e !== null ? e : "", t);
            if (r !== null && r.renderTexture !== null) {
                return new Phaser.Sprite(a._game, 0, 0)
            }
            return null
        };
