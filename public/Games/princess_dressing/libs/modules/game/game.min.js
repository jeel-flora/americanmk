        ...
        return r(n, "smoothing", function() {
            ...
            if (e) {
                var i = Math.round(this.offsetPoint.x),
                    ...
                    c = e._sourceWidth,
                    u = e._sourceHeight;
                t.Bitmap.$drawImage(this.$renderNode, e._bitmapData, e._bitmapX, e._bitmapY, s, n, i, r, o, a, h, l, c, u, null, t.BitmapFillMode.SCALE, this.$smoothing)
            }
            ...
            if (1 > o) return !1;
            for (var a; o >= 1;) {
                if (o--, i.$nextFrameNum++, a = this.frameEvents[i.$nextFrameNum], a && "" != a && t.MovieClipEvent.dispatchMovieClipEvent(i, t.MovieClipEvent.FRAME_LABEL, a), i.$nextFrameNum > i.$totalFrames || i.$frameLabelStart > 0 && i.$nextFrameNum > i.$frameLabelEnd)
        ...
        return i.get = function(t, e, r, s) {
            ...
            for (var a in t)
                if (void 0 === this._initQueueProps[a]) {
                    if (r = this._target[a], e = i._plugins[a])
                        for (s = 0, n = e.length; n > s; s++) r = e[s].init(this, a, r);
                    this._initQueueProps[a] = this._curQueueProps[a] = void 0 === r ? null : r
                } else r = this._curQueueProps[a];
            for (var a in t) {
                if (r = this._curQueueProps[a], e = i._plugins[a])
                    for (o = o || {}, s = 0, n = e.length; n > s; s++) e[s].step && e[s].step(this, a, r, t[a], o);
    ...
    var e = function(e) {
        ...
        return r(n, "bounces", function() {
            ...
            var r = Math.abs(t),
                ...
                h = e + 500 * t;
            if (0 > h || h > i)
                for (h = e; Math.abs(t) != 1 / 0 && Math.abs(t) > a;) h += t, t *= 0 > h || h > i ? o * s : o, n++;
