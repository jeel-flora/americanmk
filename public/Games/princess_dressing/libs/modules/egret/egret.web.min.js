        ...
        var r = function(r) {
            ...
            return a(o, "length", function() {
                ...
                s.open("GET", t, !0), s.responseType = "arraybuffer", console.log("loadWebAudio"), s.onload = function() {
                    a._arrayBuffer = s.response, i.decodeArr.push({
        ...
        var i = function(t) {
            function i(i) {
                ...
                t.call(this), this.loaded = !1, this.closed = !1, this.heightSet = 0 / 0, this.widthSet = 0 / 0, this.isPlayed = !1, this.screenChanged = function(e) {
                    var t = !!r.video.webkitDisplayingFullscreen;
                    t || r.checkFullScreen(!1)
                }, this._fullscreen = !0, this.onVideoLoaded = function() {
                    r.video.removeEventListener("canplay", r.onVideoLoaded);
                    var t = r.video;
                    r.loaded = !0, t.pause(), r.posterData && (r.posterData.width = r.getPlayWidth(), r.posterData.height = r.getPlayHeight()), t.width = t.videoWidth, t.height = t.videoHeight, r.$invalidateContentBounds(), r.dispatchEventWith(e.Event.COMPLETE)
            ...
            return a.load = function(e) {
                ...
                this.isPlayed = !0;
                var n = this.video;
                void 0 != t && (n.currentTime = +t || 0), n.loop = !!i, e.Capabilities.isMobile ? n.style.zIndex = "-88888" : n.style.zIndex = "9999", n.style.position = "absolute", n.style.top = "0px", n.style.left = "0px", n.height = n.videoHeight, n.width = n.videoWidth, this.checkFullScreen(this._fullscreen)
            }, a.checkFullScreen = function(t) {
                var i = this.video;
                t ? (null == i.parentElement && (i.removeAttribute("webkit-playsinline"), i.style.width = "100%", i.style.height = "100%", document.body.appendChild(i)), e.stopTick(this.markDirty, this), this.setFullScreenMonitor(!0)) : (null != i.parentElement && i.parentElement.removeChild(i), i.setAttribute("webkit-playsinline", "true"), this.setFullScreenMonitor(!1), e.Capabilities.isMobile || e.startTick(this.markDirty, this)), i.play()
                ...
                var t = this.video;
                null != t.parentElement && t.parentElement.removeChild(t), this.pause(), this.isPlayed = !1, this._fullscreen || this.$invalidateContentBounds(), this.dispatchEventWith(e.Event.ENDED)
                ...
                this._fullscreen = !!e, this.video && 0 == this.video.paused && this.checkFullScreen(this._fullscreen)
                ...
                0 >= n || 0 >= a || (this.isPlayed && !e.Capabilities.isMobile || !r ? this.isPlayed && i && !this._fullscreen && !e.Capabilities.isMobile && (t.image = i, t.drawImage(0, 0, i.width, i.height, 0, 0, n, a)) : (t.image = r, t.drawImage(0, 0, r.width, r.height, 0, 0, n, a)))
        ...
        var i = function(i) {
            ...
            return a.$setTextField = function(e) {
                ...
                if (t.multiline) {
                    ...
                    if (t.height <= t.size || t.height < i) this.setElementStyle("height", t.size * this._gscaleY + "px"), this.setElementStyle("padding", "0px"), this.setElementStyle("lineHeight", t.size * this._gscaleY + "px");
                    else {
...
! function(e) {
    ...
    ! function(t) {
        function i(e, t, i, s, o) {
            n || r();
            var h = "";
            o && (h += "italic "), s && (h += "bold "), h += (i || 12) + "px ", h += t || "Arial";
            var u = 0,
                l = a[h] || (a[h] = {});
            n.font = h;
            for (var c = e.length, d = 0; c > d; d++) {
                var f = e.charCodeAt(d),
                    g = l[f] || (l[f] = n.measureText(e.charAt(d)).width);
                u += g
            }
            return u
        }
        ...
        function r() {
            if ("canvas" == e.Capabilities.renderMode) n = e.sys.hitTestBuffer.context;
            else {
...
! function(e) {
    ...
    ! function(t) {
        function i(t, i) {
            ...
            isNaN(t) || isNaN(i) || (r.width = t, r.height = i), e.$toBitmapData(r);
            var n = r.getContext("2d");
            if (void 0 === n.imageSmoothingEnabled) {
                for (var a = ["webkitImageSmoothingEnabled", "mozImageSmoothingEnabled", "msImageSmoothingEnabled"], s = a.length - 1; s >= 0; s--) {
                    var o = a[s];
                    if (void 0 !== n[o]) break
                }
                try {
        ...
        var i = function(t) {
            ...
            return n.addListeners = function() {
                ...
                var i = document.documentElement,
                    ...
                    h = t.pageY - a,
                    u = h;
                return 90 == this.rotation ? (o = h, u = r.width - s) : -90 == this.rotation && (o = r.height - h, u = s), o /= this.scaleX, u /= this.scaleY, e.$TempPoint.setTo(Math.round(o), Math.round(u))
    ...
    ! function(t) {
        ...
        var s = function(t) {
            ...
            return i._init = function() {
                ...
                if (i.ua = t, e.Capabilities.$isMobile = -1 != t.indexOf("mobile") || -1 != t.indexOf("android"), i._canUseBlob = !1, i._audioType = n.HTML5_AUDIO, i._AudioClass = e.web.HtmlSound, i._audioMustLoad = !0, t.indexOf("windows phone") >= 0) i._System_OS = a.WPHONE, i._audioMustLoad = !1, e.Capabilities.$os = "Windows Phone";
                else if (t.indexOf("android") >= 0) {
                    if (i._System_OS = a.ADNROID, t.indexOf("ucbrowser") >= 0 && (i._audioMustLoad = !1), e.Capabilities.$os = "Android", i._System_OS = a.ADNROID, window.hasOwnProperty("QZAppExternal") && t.indexOf("qzone") >= 0) {
                        i._audioType = n.QQ_AUDIO, i._AudioClass = e.web.QQSound;
                        var r = document.getElementsByTagName("base");
                        if (r && r.length > 0) i._QQRootPath = r[0].baseURI;
                        else {
                            var s = window.location.href.indexOf("?"); - 1 == s && (s = window.location.href.length);
                            var o = window.location.href.substring(0, s);
                            o = o.substring(0, o.lastIndexOf("/")), i._QQRootPath = o + "/"
                        }
                    }
                } else t.indexOf("iphone") >= 0 || t.indexOf("ipad") >= 0 || t.indexOf("ipod") >= 0 ? (e.Capabilities.$os = "iOS", i._System_OS = a.IOS, i.getIOSVersion() >= 7 && (i._canUseBlob = !0, i._AudioClass = e.web.WebAudioSound, i._audioType = n.WEB_AUDIO)) : -1 != t.indexOf("windows nt") ? e.Capabilities.$os = "Windows PC" : -1 != t.indexOf("mac os") && (e.Capabilities.$os = "Mac OS");
                var h = window.URL || window.webkitURL;
                h || (i._canUseBlob = !1);
                var u = window.AudioContext || window.webkitAudioContext || window.mozAudioContext;
                u || i._audioType != n.WEB_AUDIO || (i._audioType = n.HTML5_AUDIO, i._AudioClass = e.web.HtmlSound), e.Sound = i._AudioClass
...
! function(e) {
    ...
    ! function(t) {
        ...
        function r(i) {
            if (!o) {
                o = !0, i || (i = {}), n(i.renderMode);
                var r = e.sys.$ticker;
                a(r), i.screenAdapter ? e.sys.screenAdapter = i.screenAdapter : e.sys.screenAdapter || (e.sys.screenAdapter = new e.sys.DefaultScreenAdapter);
                for (var s = document.querySelectorAll(".egret-player"), h = s.length, u = 0; h > u; u++) {
                    var l = s[u],
                        c = new t.WebPlayer(l, i);
                    l["egret-player"] = c
                }
            }
        }
            ...
            return a.init = function(i, r) {
                ...
                if (!t.userTyping) {
                    ...
                    var s = n ? r.height : r.width,
                        ...
                        h = e.sys.screenAdapter.calculateStageSize(this.stage.$scaleMode, s, o, i.contentWidth, i.contentHeight),
                        u = h.stageWidth,
                        l = h.stageHeight,
                        c = h.displayWidth,
                        d = h.displayHeight;
                    t.width !== u && (t.width = u), t.height !== l && (t.height = l), t.style[e.web.getPrefixStyleName("transformOrigin")] = "0% 0% 0px", t.style.width = c + "px", t.style.height = d + "px";
                    var f = 0;
                    ...
                    var p = c / u,
                        v = d / l;
                    this.webTouchHandler.updateScaleMode(p, v, f), this.webInput.$updateSize(), this.player.updateStageSize(u, l)
                }
...
! function(e) {
    ...
    ! function(t) {
        function i(t, i) {
            s || (s = document.createElement("canvas"), o = s.getContext("2d"));
            ...
            var a = i.width,
                h = i.height,
                u = s;
            u.style.width = a + "px", u.style.height = h + "px", s.width = a, s.height = h;
            var l = t,
                c = Math.round(l._offsetX),
                d = Math.round(l._offsetY),
                f = l._bitmapWidth,
                g = l._bitmapHeight;
            return o.drawImage(l._bitmapData, l._bitmapX + i.x / e.$TextureScaleFactor, l._bitmapY + i.y / e.$TextureScaleFactor, f * i.width / r, g * i.height / n, c, d, i.width, i.height), u
        }
        ...
        function a(t, i) {
            var r = e.sys.hitTestBuffer;
            r.resize(3, 3);
            var n = r.context;
            n.translate || (n = r), n.translate(1 - t, 1 - i);
            var a = this._bitmapWidth,
                s = this._bitmapHeight,
                o = e.$TextureScaleFactor;
            n.drawImage(this._bitmapData, this._bitmapX, this._bitmapY, a, this._bitmapHeight, this._offsetX, this._offsetY, a * o, s * o), n.$drawWebGL && n.$drawWebGL();
            try {
                var h = r.getPixel(1, 1)
            } catch (u) {
                throw console.log(this), new Error(e.sys.tr(1039))
            }
            return h
        }
        var s, o;
        e.Texture.prototype.toDataURL = r, e.Texture.prototype.saveToFile = n, e.Texture.prototype.getPixel32 = a;
        var h = e.Texture.prototype.dispose;
        e.Texture.prototype.dispose = function() {
            t.WebGLUtils.deleteWebGLTexture(this._bitmapData), h.call(this)
        }
    }(t = e.web || (e.web = {}))
}(egret || (egret = {}));
var egret;
! function(e) {
    ...
    ! function(t) {
        ...
        function r(e, t) {
            ...
            for (var i = new a(e.localName, t, e.prefix, e.namespaceURI, e.nodeName), n = e.attributes, o = i.attributes, h = n.length, u = 0; h > u; u++) {
                var l = n[u],
                    c = l.name;
                0 != c.indexOf("xmlns:") && (o[c] = l.value, i["$" + c] = l.value)
            }
            var d = e.childNodes;
            h = d.length;
            var f = i.children;
...
! function(e) {
    ...
    ! function(t) {
        var i = function() {
            ...
            var i = (__define, t);
            i.prototype;
            return t.compileProgram = function(i, r, n) {
                var a = t.compileFragmentShader(i, n),
                    s = t.compileVertexShader(i, r),
                    o = i.createProgram();
                return i.attachShader(o, s), i.attachShader(o, a), i.linkProgram(o), i.getProgramParameter(o, i.LINK_STATUS) || e.$warn(1020), o
                ...
                return e.shaderSource(r, t), e.compileShader(r), e.getShaderParameter(r, e.COMPILE_STATUS) ? r : null
            ...
            }, t.deleteWebGLTexture = function(e) {
                if (e) {
                    var t = e.webGLTexture;
                    if (t)
                        for (var i in t) {
                            var r = t[i],
                                n = r.glContext;
        ...
        t.WebGLUtils = i, e.registerClass(i, "egret.web.WebGLUtils")
    }(t = e.web || (e.web = {}))
}(egret || (egret = {}));
var egret;
! function(e) {
    ...
    ! function(t) {
        var i = function() {
            ...
            return r.init = function() {
                ...
                for (var r in this.uniforms) this.uniforms[r].uniformLocation = e.getUniformLocation(i, r);
                ...
                if (this.uniforms) {
                    var e, t = this.gl;
                    for (var i in this.uniforms) e = this.uniforms[i], 1 === e.glValueLength ? e.glMatrix === !0 ? e.glFunc.call(t, e.uniformLocation, e.transpose, e.value) : e.glFunc.call(t, e.uniformLocation, e.value) : 2 === e.glValueLength ? e.glFunc.call(t, e.uniformLocation, e.value.x, e.value.y) : 3 === e.glValueLength ? e.glFunc.call(t, e.uniformLocation, e.value.x, e.value.y, e.value.z) : 4 === e.glValueLength && e.glFunc.call(t, e.uniformLocation, e.value.x, e.value.y, e.value.z, e.value.w)
                }
            }, e
        }();
...
! function(e) {
    ...
    ! function(t) {
        var i = function() {
            function e(e) {
                this.gl = null, this.program = null, this.projectionVector = null, this.offsetVector = null, this.tintColor = null, this.aVertexPosition = null, this.colorAttribute = null, this.attributes = null, this.translationMatrix = null, this.alpha = null, this.fragmentSrc = "precision mediump float;\nvarying vec4 vColor;\nvoid main(void) {\n   gl_FragColor = vColor;\n}", this.vertexSrc = "attribute vec2 aVertexPosition;\nattribute vec4 aColor;\nuniform mat3 translationMatrix;\nuniform vec2 projectionVector;\nuniform vec2 offsetVector;\nuniform float alpha;\nuniform vec3 tint;\nvarying vec4 vColor;\nvoid main(void) {\n   vec3 v = translationMatrix * vec3(aVertexPosition , 1.0);\n   v -= offsetVector.xyx;\n   gl_Position = vec4( v.x / projectionVector.x -1.0, v.y / -projectionVector.y + 1.0 , 0.0, 1.0);\n   vColor = aColor * vec4(tint * alpha, alpha);\n}", this.gl = e, this.init()
            }
            var i = (__define, e),
                r = i.prototype;
            return r.init = function() {
...
! function(e) {
    ...
    ! function(t) {
        var i = function() {
            function e(e) {
                this.gl = null, this.maxAttibs = 10, this.attribState = [], this.tempAttribState = [], this.currentShader = null, this.defaultShader = null, this.primitiveShader = null, this.colorTransformShader = null, this.blurShader = null;
            ...
            return r.setContext = function(e) {
                this.gl = e, this.primitiveShader = new t.PrimitiveShader(e), this.defaultShader = new t.EgretShader(e), this.defaultShader.init(), this.colorTransformShader = new t.ColorTransformShader(e), this.blurShader = new t.BlurShader(e), this.activateShader(this.defaultShader)
            }, r.activateShader = function(e) {
...
! function(e) {
    ...
    ! function(t) {
        var i = function() {
            function e(e, t, i, r) {
                void 0 === r && (r = !0), this.gl = e, this.width = t || 1, this.height = i || 1, this.useFrameBuffer = r, this.texture = this.createTexture(), this.frameBuffer = e.createFramebuffer(), e.bindFramebuffer(e.FRAMEBUFFER, this.frameBuffer), e.framebufferTexture2D(e.FRAMEBUFFER, e.COLOR_ATTACHMENT0, e.TEXTURE_2D, this.texture, 0), this.stencilBuffer = e.createRenderbuffer(), e.bindRenderbuffer(e.RENDERBUFFER, this.stencilBuffer), e.renderbufferStorage(e.RENDERBUFFER, e.DEPTH_STENCIL, this.width, this.height), e.framebufferRenderbuffer(e.FRAMEBUFFER, e.DEPTH_STENCIL_ATTACHMENT, e.RENDERBUFFER, this.stencilBuffer), e.bindFramebuffer(e.FRAMEBUFFER, null)
            }
            var t = (__define, e),
                i = t.prototype;
            return i.resize = function(e, t) {
                var i = this.gl;
                this.width = e || 1, this.height = t || 1, i.bindTexture(i.TEXTURE_2D, this.texture), i.texImage2D(i.TEXTURE_2D, 0, i.RGBA, this.width, this.height, 0, i.RGBA, i.UNSIGNED_BYTE, null), i.bindTexture(i.TEXTURE_2D, null), i.bindFramebuffer(i.FRAMEBUFFER, this.frameBuffer), i.bindRenderbuffer(i.RENDERBUFFER, this.stencilBuffer), i.renderbufferStorage(i.RENDERBUFFER, i.DEPTH_STENCIL, this.width, this.height), i.bindFramebuffer(i.FRAMEBUFFER, null)
            }, i.getFrameBuffer = function() {
                return this.useFrameBuffer ? this.frameBuffer : null
            }, i.createTexture = function() {
                var e = this.gl,
                    t = e.createTexture();
...
! function(e) {
    ...
    ! function(t) {
        function i(t, i) {
            var r = document.createElement("canvas");
            return isNaN(t) || isNaN(i) || (r.width = t, r.height = i), e.$toBitmapData(r), r
        }
        var r = function() {
            function r(r, n) {
                this.dirtyRegionPolicy = !0, this._dirtyRegionPolicy = !0, this.glID = null, this.size = 2e3, this.vertices = null, this.vertSize = 5, this.indices = null, this.projectionX = 0 / 0, this.projectionY = 0 / 0, this.shaderManager = null, this.contextLost = !1, this.currentBaseTexture = null, this.currentBatchSize = 0, this.drawData = [], this.$drawCalls = 0, this.$computeDrawCall = !1, this.globalMatrix = new e.Matrix, this.savedGlobalMatrix = new e.Matrix, this._globalAlpha = 1, this.$stencilList = [], this.stencilHandleCount = 0, this.surface = i(r, n), this.initWebGL(), this.rootRenderTarget = new t.WebGLRenderTarget(this.context, this.surface.width, this.surface.height), this.currentRenderTarget = this.rootRenderTarget, this.rebindRenderTarget()
            }
            var n = __define,
                a = r,
                s = a.prototype;
            return s.createRenderTarget = function() {
                var e = new t.WebGLRenderTarget(this.context, this.surface.width, this.surface.height);
                return this.rebindRenderTarget(), e
            }, s.setRenderTarget = function(e) {
                this.currentRenderTarget = e, this.rebindRenderTarget()
            }, s.resetRenderTarget = function() {
                this.currentRenderTarget = this.rootRenderTarget, this.rebindRenderTarget()
            }, s.rebindRenderTarget = function() {
                var e = this.context;
                e.bindFramebuffer(e.FRAMEBUFFER, this.currentRenderTarget.getFrameBuffer())
            }, n(s, "width", function() {
                return this.surface.width
            }), n(s, "height", function() {
                return this.surface.height
            }), s.resize = function(e, t, i) {
                var r = this.surface;
                i ? (r.width < e && (r.width = e), r.height < t && (r.height = t)) : (r.width != e && (r.width = e), r.height != t && (r.height = t)), this.currentRenderTarget.resize(this.surface.width, this.surface.height), this.rebindRenderTarget(), this.onResize(), this.clear()
            }, s.resizeTo = function(e, t, i, r) {
                var n = this.surface,
                    a = n.width,
                    s = n.height;
                this.surface.width = e, this.surface.height = t, this.drawFrameBufferToSurface(0, 0, a, s, i, r, a, s, !0)
            }, s.setDirtyRegionPolicy = function(e) {
                this.dirtyRegionPolicy = "on" == e
            }, s.beginClip = function(e, t, i) {
                this._dirtyRegionPolicy ? (this.rootRenderTarget.useFrameBuffer = !0, this.rebindRenderTarget()) : (this.rootRenderTarget.useFrameBuffer = !1, this.rebindRenderTarget(), this.clear()), t = +t || 0, i = +i || 0, this.setTransform(1, 0, 0, 1, t, i);
                var r = e.length;
                if (1 == r && 0 == e[0].minX && 0 == e[0].minY && e[0].width == this.surface.width && e[0].height == this.surface.height) return this.maskPushed = !1, void(this.rootRenderTarget.useFrameBuffer && this.clear());
                for (var n = 0; r > n; n++) {
                    var a = e[n];
                    this.clearRect(a.minX, a.minY, a.width, a.height)
                }
                r > 0 ? (this.pushMask(e), this.maskPushed = !0, this.offsetX = t, this.offsetY = i) : this.maskPushed = !1
            }, s.endClip = function() {
                this.maskPushed && (this.setTransform(1, 0, 0, 1, this.offsetX, this.offsetY), this.popMask())
            }, s.getPixel = function(e, t) {
                var i = this.context,
                    r = new Uint8Array(4),
                    n = this.currentRenderTarget.useFrameBuffer;
                return this.currentRenderTarget.useFrameBuffer = !0, this.rebindRenderTarget(), i.readPixels(e, t, 1, 1, i.RGBA, i.UNSIGNED_BYTE, r), this.currentRenderTarget.useFrameBuffer = n, this.rebindRenderTarget(), r
            }, s.toDataURL = function(e, t) {
                return this.surface.toDataURL(e, t)
            }, s.clear = function() {
                if (0 != this.surface.width && 0 != this.surface.height) {
                    var e = this.context;
                    e.colorMask(!0, !0, !0, !0), e.clearColor(0, 0, 0, 0), e.clear(e.COLOR_BUFFER_BIT)
                }
            }, s.clearRect = function(e, t, i, r) {
                this.setGlobalCompositeOperation("destination-out"), this.drawRect(e, t, i, r), this.setGlobalCompositeOperation("source-over")
            }, s.destroy = function() {
                this.surface.width = this.surface.height = 0
            }, s.onResize = function() {
                this.projectionX = this.surface.width / 2, this.projectionY = -this.surface.height / 2, this.context && this.context.viewport(0, 0, this.surface.width, this.surface.height)
            }, s.initWebGL = function() {
                this.onResize(), this.surface.addEventListener("webglcontextlost", this.handleContextLost.bind(this), !1), this.surface.addEventListener("webglcontextrestored", this.handleContextRestored.bind(this), !1);
                var e = 4 * this.size * this.vertSize,
                    i = 6 * this.size;
                this.vertices = new Float32Array(e), this.indices = new Uint16Array(i);
                ...
                this.getWebGLContext(), this.shaderManager = new t.WebGLShaderManager(this.context)
            }, s.handleContextLost = function() {
                this.contextLost = !0
            }, s.handleContextRestored = function() {
                this.initWebGL(), this.contextLost = !1
            }, s.getWebGLContext = function() {
                for (var t, i = {
                        stencil: !0
                    }, r = ["webgl", "experimental-webgl"], n = 0; n < r.length; n++) {
                    try {
                        t = this.surface.getContext(r[n], i)
                    } catch (a) {}
                    if (t) break
                }
                t || e.$error(1021), this.setContext(t), this.setGlobalCompositeOperation("source-over")
            }, s.setContext = function(e) {
                this.context = e, e.id = r.glContextId++, this.glID = e.id, this.vertexBuffer = e.createBuffer(), this.indexBuffer = e.createBuffer(), e.bindBuffer(e.ELEMENT_ARRAY_BUFFER, this.indexBuffer), e.bufferData(e.ELEMENT_ARRAY_BUFFER, this.indices, e.STATIC_DRAW), e.bindBuffer(e.ARRAY_BUFFER, this.vertexBuffer), e.bufferData(e.ARRAY_BUFFER, this.vertices, e.DYNAMIC_DRAW), e.disable(e.DEPTH_TEST), e.disable(e.CULL_FACE), e.enable(e.BLEND), e.colorMask(!0, !0, !0, !0)
            }, s.drawImage = function(e, t, i, r, n, a, s, o, h, u, l) {
                if (!this.contextLost && e) {
                    this.createWebGLTexture(e);
                    var c = e.webGLTexture[this.glID];
                    c && this.drawTexture(c, t, i, r, n, a, s, o, h, u, l)
                }
            }, s.drawTexture = function(e, t, i, r, n, a, s, o, h, u, l) {
                if (!this.contextLost && e) {
                    var c = e;
                    this.currentBatchSize >= this.size - 1 ? (this.$drawWebGL(), this.currentBaseTexture = c, this.drawData.push({
                        type: 0,
                        texture: this.currentBaseTexture,
                        count: 0
                    })) : c !== this.currentBaseTexture && (this.currentBaseTexture = c, this.drawData.push({
                        type: 0,
                        texture: this.currentBaseTexture,
                        count: 0
                    })), this.drawUvRect(t, i, r, n, a, s, o, h, u, l), this.currentBatchSize++, this.drawData[this.drawData.length - 1].count++
                }
            }, s.drawRect = function(e, t, i, r) {
                this.contextLost || (this.currentBatchSize >= this.size - 1 ? (this.$drawWebGL(), this.drawData.push({
                    type: 1,
                    rect: 1,
                    count: 0
                })) : this.drawData.length > 1 && this.drawData[this.drawData.length - 2].rect || this.drawData.push({
                    type: 1,
                    rect: 1,
                    count: 0
                }), this.drawUvRect(0, 0, i, r, e, t, i, r, i, r), this.currentBatchSize++, this.drawData[this.drawData.length - 1].count++, this.currentBaseTexture = null)
            }, s.drawUvRect = function(e, t, i, r, n, a, s, o, h, u) {
                var l = h,
                    c = u,
                    d = this.globalMatrix,
                    f = d.a,
                    ...
                    m = d.tx,
                    b = d.ty;
                (0 != n || 0 != a) && d.append(1, 0, 0, 1, n, a), (i / s != 1 || r / o != 1) && d.append(s / i, 0, 0, o / r, 0, 0);
                var x = d.a,
                    w = d.b,
                    E = d.c,
                    y = d.d,
                    T = d.tx,
                    _ = d.ty;
                d.a = f, d.b = g, d.c = p, d.d = v, d.tx = m, d.ty = b;
                var S = l,
                    C = c,
                    R = i,
                    L = r;
                ...
                var D = this.vertices,
                    ...
                    $ = this._globalAlpha;
                D[A++] = T, D[A++] = _, D[A++] = e, D[A++] = t, D[A++] = $, D[A++] = x * R + T, D[A++] = w * R + _, D[A++] = i + e, D[A++] = t, D[A++] = $, D[A++] = x * R + E * L + T, D[A++] = y * L + w * R + _, D[A++] = i + e, D[A++] = r + t, D[A++] = $, D[A++] = E * L + T, D[A++] = y * L + _, D[A++] = e, D[A++] = r + t, D[A++] = $
            }, s.$drawWebGL = function() {
                if (!(0 == this.currentBatchSize && 0 == this.drawData.length || this.contextLost)) {
                    this.start();
                    var e = this.context,
                        t = this.vertices.subarray(0, 4 * this.currentBatchSize * this.vertSize);
                    e.bufferSubData(e.ARRAY_BUFFER, 0, t);
                    for (var i = this.drawData.length, n = 0, a = 0; i > a; a++) {
                        var s = this.drawData[a];
                        switch (s.type) {
                            case 0:
                                n += this.drawTextureElements(s, n);
                                break;
                            case 1:
                                n += this.drawRectElements(s, n);
                                break;
                            case 2:
                                n += this.drawPushMaskElements(s, n);
                                break;
                            case 3:
                                n += this.drawPopMaskElements(s, n);
                                break;
                            case 4:
                                var o = r.blendModesForGL[s.value];
                                o && this.context.blendFunc(o[0], o[1])
                        }
                        4 != s.type && this.$computeDrawCall && this.$drawCalls++
                    }
                    this.drawData.length = 0, this.currentBatchSize = 0, this.currentBaseTexture = null
                }
            }, s.start = function() {
                if (!this.contextLost) {
                    var e = this.context;
                    ...
                    var t;
                    t = "colorTransform" == this.filterType ? this.shaderManager.colorTransformShader : "blur" == this.filterType ? this.shaderManager.blurShader : this.shaderManager.defaultShader, this.shaderManager.activateShader(t), t.syncUniforms(), e.uniform2f(t.projectionVector, this.projectionX, this.projectionY), this.switchDrawingTextureState(!0);
                    var i = 4 * this.vertSize;
                    e.vertexAttribPointer(t.aVertexPosition, 2, e.FLOAT, !1, i, 0), e.vertexAttribPointer(t.aTextureCoord, 2, e.FLOAT, !1, i, 8), e.vertexAttribPointer(t.colorAttribute, 2, e.FLOAT, !1, i, 16)
                }
            }, s.createWebGLTexture = function(e) {
                var t = e;
                if (t.webGLTexture || (t.webGLTexture = {}), !t.webGLTexture[this.glID]) {
                    var i = this.createTexture(t);
                    t.webGLTexture[this.glID] = i
                }
            }, s.createTexture = function(e) {
                var t = this.context,
                    i = t.createTexture();
                return i ? (i.glContext = t, t.bindTexture(t.TEXTURE_2D, i), t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !0), t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, t.RGBA, t.UNSIGNED_BYTE, e), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MAG_FILTER, t.LINEAR), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, t.LINEAR), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_S, t.CLAMP_TO_EDGE), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_T, t.CLAMP_TO_EDGE), t.bindTexture(t.TEXTURE_2D, null), i) : void(this.contextLost = !0)
            }, s.onRenderFinish = function() {
                this.$drawCalls = 0, this.currentRenderTarget == this.rootRenderTarget && (!this._dirtyRegionPolicy && this.dirtyRegionPolicy && this.drawSurfaceToFrameBuffer(0, 0, this.surface.width, this.surface.height, 0, 0, this.surface.width, this.surface.height, !0), this._dirtyRegionPolicy && this.drawFrameBufferToSurface(0, 0, this.surface.width, this.surface.height, 0, 0, this.surface.width, this.surface.height), this._dirtyRegionPolicy = this.dirtyRegionPolicy)
            }, s.drawFrameBufferToSurface = function(e, t, i, r, n, a, s, o, h) {
                void 0 === h && (h = !1);
                var u = this.context;
                this.currentRenderTarget.useFrameBuffer = !1, this.rebindRenderTarget(), u.disable(u.STENCIL_TEST), this.globalMatrix.setTo(1, 0, 0, -1, 0, this.surface.height), this._globalAlpha = 1, this.setGlobalCompositeOperation("source-over"), h && this.clear(), this.drawTexture(this.currentRenderTarget.texture, e, t, i, r, n, a, s, o, i, r), this.$drawWebGL(), this.currentRenderTarget.useFrameBuffer = !0, this.rebindRenderTarget(), this.maskPushed && u.enable(u.STENCIL_TEST)
            }, s.drawSurfaceToFrameBuffer = function(e, t, i, r, n, a, s, o, h) {
                void 0 === h && (h = !1);
                var u = this.context;
                this.currentRenderTarget.useFrameBuffer = !0, this.rebindRenderTarget(), u.disable(u.STENCIL_TEST), this.globalMatrix.setTo(1, 0, 0, 1, 0, 0), this._globalAlpha = 1, this.setGlobalCompositeOperation("source-over"), h && this.clear(), this.drawImage(this.surface, e, t, i, r, n, a, s, o, i, r), this.$drawWebGL(), this.currentRenderTarget.useFrameBuffer = !1, this.rebindRenderTarget(), this.maskPushed && u.enable(u.STENCIL_TEST)
            }, s.setTransform = function(e, t, i, r, n, a) {
                this.globalMatrix.setTo(e, t, i, r, n, a)
            }, s.transform = function(e, t, i, r, n, a) {
                this.globalMatrix.append(e, t, i, r, n, a)
            }, s.translate = function(e, t) {
                this.globalMatrix.translate(e, t)
            }, s.saveTransform = function() {
                this.savedGlobalMatrix.copyFrom(this.globalMatrix)
            }, s.restoreTransform = function() {
                this.globalMatrix.copyFrom(this.savedGlobalMatrix)
            }, s.setGlobalAlpha = function(e) {
                this._globalAlpha = e
            }, s.setGlobalCompositeOperation = function(e) {
                this.currentBlendMode != e && (this.drawData.push({
                    type: 4,
                    value: e
                }), this.currentBlendMode = e, this.currentBaseTexture = null)
            }, s.pushMask = function(e) {
                this.$stencilList.push(e), this.currentBatchSize >= this.size - 1 ? (this.$drawWebGL(), this.drawData.push({
                    type: 2,
                    pushMask: e,
                    count: 0
                })) : this.drawData.push({
                    ...
                    pushMask: e,
                    count: 0
                }), this.drawMask(e), this.currentBaseTexture = null
            }, s.popMask = function() {
                var e = this.$stencilList.pop();
                this.currentBatchSize >= this.size - 1 ? (this.$drawWebGL(), this.drawData.push({
                    type: 3,
                    popMask: e,
                    count: 0
                })) : this.drawData.push({
            ...
            }, s.drawMask = function(e) {
                if (!this.contextLost) {
                    var t = e.length;
                    if (t)
                        for (var i = 0; t > i; i++) {
                            var r = e[i];
                            this.drawUvRect(0, 0, r.width, r.height, r.minX, r.minY, r.width, r.height, r.width, r.height), this.currentBatchSize++, this.drawData[this.drawData.length - 1].count++
                        } else this.drawUvRect(0, 0, e.width, e.height, e.x, e.y, e.width, e.height, e.width, e.height), this.currentBatchSize++, this.drawData[this.drawData.length - 1].count++
                }
            }, s.switchDrawingTextureState = function(e) {
                if (e != this.drawingTexture) {
                    var t = this.context,
                        i = this.shaderManager.defaultShader;
                    e ? t.uniform1f(i.uPureColor, 0) : t.uniform1f(i.uPureColor, 1), this.drawingTexture = e
                }
            }, s.drawTextureElements = function(e, t) {
                this.switchDrawingTextureState(!0);
                var i = this.context;
                i.bindTexture(i.TEXTURE_2D, e.texture);
                var r = 6 * e.count;
                return i.drawElements(i.TRIANGLES, r, i.UNSIGNED_SHORT, 2 * t), r
            }, s.drawRectElements = function(e, t) {
                this.switchDrawingTextureState(!1);
                var i = this.context;
                i.bindTexture(i.TEXTURE_2D, null);
                var r = 6 * e.count;
                return i.drawElements(i.TRIANGLES, r, i.UNSIGNED_SHORT, 2 * t), r
            }, s.drawPushMaskElements = function(e, t) {
                this.switchDrawingTextureState(!1);
                var i = this.context;
                0 == this.stencilHandleCount && (i.enable(i.STENCIL_TEST), i.clear(i.STENCIL_BUFFER_BIT));
                var r = this.stencilHandleCount;
                this.stencilHandleCount++, i.colorMask(!1, !1, !1, !1), i.stencilFunc(i.EQUAL, r, 255), i.stencilOp(i.KEEP, i.KEEP, i.INCR), i.bindTexture(i.TEXTURE_2D, null);
                var n = 6 * e.count;
                return i.drawElements(i.TRIANGLES, n, i.UNSIGNED_SHORT, 2 * t), i.stencilFunc(i.EQUAL, r + 1, 255), i.colorMask(!0, !0, !0, !0), i.stencilOp(i.KEEP, i.KEEP, i.KEEP), n
            }, s.drawPopMaskElements = function(e, t) {
                this.switchDrawingTextureState(!1);
                var i = this.context;
                if (this.stencilHandleCount--, 0 == this.stencilHandleCount) {
                    i.disable(i.STENCIL_TEST);
                    var r = 6 * e.count;
                    return r
                }
                var n = this.stencilHandleCount;
                i.colorMask(!1, !1, !1, !1), i.stencilFunc(i.EQUAL, n + 1, 255), i.stencilOp(i.KEEP, i.KEEP, i.DECR), i.bindTexture(i.TEXTURE_2D, null);
                var r = 6 * e.count;
                return i.drawElements(i.TRIANGLES, r, i.UNSIGNED_SHORT, 2 * t), i.stencilFunc(i.EQUAL, n, 255), i.colorMask(!0, !0, !0, !0), i.stencilOp(i.KEEP, i.KEEP, i.KEEP), r
            }, r.initBlendMode = function() {
                r.blendModesForGL = {}, r.blendModesForGL["source-over"] = [1, 771], r.blendModesForGL.lighter = [770, 1], r.blendModesForGL["destination-out"] = [0, 771], r.blendModesForGL["destination-in"] = [0, 770]
            }, r.glContextId = 0, r.blendModesForGL = null, r
        }();
        t.WebGLRenderBuffer = r, e.registerClass(r, "egret.web.WebGLRenderBuffer", ["egret.sys.RenderBuffer"]), r.initBlendMode()
    }(t = e.web || (e.web = {}))
}(egret || (egret = {}));
var egret;
! function(e) {
        ...
        var i = ["source-over", "lighter", "destination-out"],
            ...
            a = function() {
                ...
                return o.render = function(e, t, i, r, a) {
                    ...
                    var s = t,
                        o = a ? e : null;
                    this.drawDisplayObject(e, s, r, i, null, null, o), s.$drawWebGL();
                    var h = s.$drawCalls;
                    if (s.onRenderFinish(), this.nestLevel--, 0 === this.nestLevel) {
                        n.length > 6 && (n.length = 6);
                        for (var u = n.length, l = 0; u > l; l++) n[l].resize(0, 0)
                    }
                    return h
                }, o.drawDisplayObject = function(t, i, r, n, a, s, o) {
                    var h, u = 0;
                    if (a && !o ? (a.isDirty && (u += a.drawToSurface()), h = a.$renderNode) : h = t.$getRenderNode(), h) {
                        if (r) {
                            var l = h.renderRegion;
                            if (s && !s.intersects(l)) h.needRedraw = !1;
                            else if (!h.needRedraw)
                                for (var c = r.length, d = 0; c > d; d++)
                                    if (l.intersects(r[d])) {
                                        h.needRedraw = !0;
                                        break
                                    }
                        ...
                        if (h.needRedraw) {
                            u++;
                            var f, g;
                            o ? (f = t.$getConcatenatedAlphaAt(o, t.$getConcatenatedAlpha()), g = e.Matrix.create().copyFrom(t.$getConcatenatedMatrix()), t.$getConcatenatedMatrixAt(o, g), n.$preMultiplyInto(g, g), i.setTransform(g.a, g.b, g.c, g.d, g.tx, g.ty), e.Matrix.release(g)) : (f = h.renderAlpha, g = h.renderMatrix, i.setTransform(g.a, g.b, g.c, g.d, g.tx + n.tx, g.ty + n.ty)), i.setGlobalAlpha(f), this.renderNode(h, i), h.needRedraw = !1
                        }
                    }
                    if (a && !o) return u;
                    var p = t.$children;
                    if (p)
                        for (var v = p.length, m = 0; v > m; m++) {
                            var b = p[m];
                            !b.$visible || b.$alpha <= 0 || b.$maskedObject || (0 !== b.$blendMode || b.$mask && (b.$mask.$parentDisplayList || o) ? u += this.drawWithClip(b, i, r, n, s, o) : b.$scrollRect || b.$maskRect ? u += this.drawWithScrollRect(b, i, r, n, s, o) : b.isFPS ? (i.$drawWebGL(), i.$computeDrawCall = !1, this.drawDisplayObject(b, i, r, n, b.$displayList, s, o), i.$drawWebGL(), i.$computeDrawCall = !0) : u += this.drawDisplayObject(b, i, r, n, b.$displayList, s, o))
                        }
                    return u
                }, o.drawWithClip = function(a, s, o, h, u, l) {
                    var c = 0,
                        d = 0 !== a.$blendMode;
                    if (d) {
                        var f = i[a.$blendMode];
                    ...
                    var g, p = a.$scrollRect ? a.$scrollRect : a.$maskRect,
                        v = a.$mask,
                        m = e.Matrix.create();
                    if (m.copyFrom(a.$getConcatenatedMatrix()), a.$parentDisplayList) {
                        var b, x = a.$parentDisplayList.root;
                        x !== a.$stage && a.$getConcatenatedMatrixAt(x, m)
                    }
                    if (v) {
                        var w = v.$getOriginalBounds();
                        g = e.sys.Region.create();
                        var E = e.Matrix.create();
                        E.copyFrom(v.$getConcatenatedMatrix()), b && b.$preMultiplyInto(E, E), g.updateRegion(w, E), e.Matrix.release(E)
                    }
                    var y;
                    if (p && (y = e.sys.Region.create(), y.updateRegion(p, m)), y && g ? (y.intersect(g), e.sys.Region.release(g)) : !y && g && (y = g), y) {
                        if (y.isEmpty() || u && !u.intersects(y)) return e.sys.Region.release(y), e.Matrix.release(m), c
                    } else y = e.sys.Region.create(), w = a.$getOriginalBounds(), y.updateRegion(w, m);
                    var T = !1;
                    if (o) {
                    ...
                    if (!T) return e.sys.Region.release(y), e.Matrix.release(m), c;
                    if (v || a.$children && 0 != a.$children.length) {
                        var C = this.createRenderBuffer(y.width, y.height),
                            R = C.context;
                        if (!R) return c += this.drawDisplayObject(a, s, o, h, a.$displayList, u, l), e.sys.Region.release(y), e.Matrix.release(m), c;
                        if (p) {
                            var E = m;
                            C.setTransform(E.a, E.b, E.c, E.d, E.tx - y.minX, E.ty - y.minY), C.pushMask(p)
                        }
                        C.setTransform(1, 0, 0, 1, -y.minX, -y.minY);
                        var L = e.Matrix.create().setTo(1, 0, 0, 1, -y.minX, -y.minY);
                        if (c += this.drawDisplayObject(a, C, o, L, a.$displayList, y, l ? a : null), e.Matrix.release(L), v) {
                            var D = this.createRenderBuffer(y.width, y.height),
                                A = D.context;
                            if (!A) return c += this.drawDisplayObject(a, s, o, h, a.$displayList, u, l), p && C.popMask(), n.push(C), e.sys.Region.release(y), e.Matrix.release(m), c;
                            D.setTransform(1, 0, 0, 1, -y.minX, -y.minY), L = e.Matrix.create().setTo(1, 0, 0, 1, -y.minX, -y.minY);
                            var $ = this.drawDisplayObject(v, D, o, L, v.$displayList, y, l ? v : null);
                            if (e.Matrix.release(L), $ > 0) {
                                c += $, C.setGlobalCompositeOperation("destination-in"), C.setTransform(1, 0, 0, 1, 0, 0), C.setGlobalAlpha(1), D.$drawWebGL(), D.onRenderFinish(), t.WebGLUtils.deleteWebGLTexture(D.surface);
                                var M = D.surface.width,
                                    I = D.surface.height;
                                C.drawImage(D.surface, 0, 0, M, I, 0, 0, M, I, M, I)
                            }
                            n.push(D)
                        }
                        if (c > 0) {
                            c++, d && s.setGlobalCompositeOperation(f), s.setGlobalAlpha(1), s.setTransform(1, 0, 0, 1, y.minX + h.tx, y.minY + h.ty), C.$drawWebGL(), C.onRenderFinish(), t.WebGLUtils.deleteWebGLTexture(C.surface);
                            var O = C.surface.width,
                                B = C.surface.height;
                            s.drawImage(C.surface, 0, 0, O, B, 0, 0, O, B, O, B), d && s.setGlobalCompositeOperation(r)
                        }
                        return C.setGlobalCompositeOperation(r), p && C.popMask(), n.push(C), e.sys.Region.release(y), e.Matrix.release(m), c
                    }
                    if (p) {
                        var E = m;
                        s.setTransform(E.a, E.b, E.c, E.d, E.tx - y.minX, E.ty - y.minY), s.pushMask(p)
                    }
                    var L = e.Matrix.create().setTo(1, 0, 0, 1, 0, 0);
                    return d && s.setGlobalCompositeOperation(f), c += this.drawDisplayObject(a, s, o, L, a.$displayList, y, null), e.Matrix.release(L), d && s.setGlobalCompositeOperation(r), p && s.pushMask(p), e.sys.Region.release(y), e.Matrix.release(m), c
                }, o.drawWithScrollRect = function(t, i, r, n, a, s) {
                    var o = 0,
                        h = t.$scrollRect ? t.$scrollRect : t.$maskRect;
                    if (0 == h.width || 0 == h.height) return o;
                    var u = e.Matrix.create();
                    if (u.copyFrom(t.$getConcatenatedMatrix()), t.$parentDisplayList) {
                        var l = t.$parentDisplayList.root;
                        l !== t.$stage && t.$getConcatenatedMatrixAt(l, u)
                    }
                    var c = e.sys.Region.create();
                    if (h.isEmpty() || c.updateRegion(h, u), c.isEmpty() || a && !a.intersects(c)) return e.sys.Region.release(c), e.Matrix.release(u), o;
                    var d = !1;
                    if (r) {
                        for (var f = r.length, g = 0; f > g; g++)
                            if (c.intersects(r[g])) {
                                d = !0;
                                break
                            }
                    } else d = !0;
                    return d ? (i.setTransform(u.a, u.b, u.c, u.d, u.tx + n.tx, u.ty + n.ty), i.pushMask(h), o += this.drawDisplayObject(t, i, r, n, t.$displayList, c, s), i.setTransform(u.a, u.b, u.c, u.d, u.tx + n.tx, u.ty + n.ty), i.popMask(), e.sys.Region.release(c), e.Matrix.release(u), o) : (e.sys.Region.release(c), e.Matrix.release(u), o)
                    ...
                    switch (e.type) {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            t.setTransform(e.drawData[0], e.drawData[1], e.drawData[2], e.drawData[3], e.drawData[4], e.drawData[5]);
                            break;
                        case 6:
                            t.setGlobalAlpha(e.drawData[0])
                    }
                    ...
                    var i = e.image,
                        ...
                        a = 0,
                        s = e.matrix;
                    for (s && (t.saveTransform(), t.transform(s.a, s.b, s.c, s.d, s.tx, s.ty)); n > a;) t.drawImage(i, r[a++], r[a++], r[a++], r[a++], r[a++], r[a++], r[a++], r[a++], e.imageWidth, e.imageHeight);
                    s && t.restoreTransform()
                }, o.renderText = function(i, r) {
                    var n = i.width - i.x,
                        a = i.height - i.y;
                    if (0 != i.drawData.length && (i.$canvasRenderBuffer && i.$canvasRenderBuffer.context ? i.$canvasRenderBuffer.resize(n, a, !0) : (i.$canvasRenderer = new e.CanvasRenderer, i.$canvasRenderBuffer = new t.CanvasRenderBuffer(n, a)), i.$canvasRenderBuffer.context)) {
                        (i.x || i.y) && (i.dirtyRender && i.$canvasRenderBuffer.context.translate(-i.x, -i.y), r.transform(1, 0, 0, 1, i.x, i.y));
                        var s = i.$canvasRenderBuffer.surface;
                        i.dirtyRender && (t.WebGLUtils.deleteWebGLTexture(s), i.$canvasRenderer.renderText(i, i.$canvasRenderBuffer.context)), r.drawImage(s, 0, 0, n, a, 0, 0, n, a, s.width, s.height), (i.x || i.y) && (i.dirtyRender && i.$canvasRenderBuffer.context.translate(i.x, i.y), r.transform(1, 0, 0, 1, -i.x, -i.y)), i.dirtyRender = !1
                    }
                }, o.renderGraphics = function(i, r, n) {
                    var a = i.width,
                        s = i.height;
                    if (!(0 >= a || 0 >= s) && (i.$canvasRenderBuffer && i.$canvasRenderBuffer.context ? i.dirtyRender && i.$canvasRenderBuffer.resize(a, s, !0) : (i.$canvasRenderer = new e.CanvasRenderer, i.$canvasRenderBuffer = new t.CanvasRenderBuffer(a, s)), i.$canvasRenderBuffer.context)) {
                        (i.x || i.y) && (i.dirtyRender && i.$canvasRenderBuffer.context.translate(-i.x, -i.y), r.transform(1, 0, 0, 1, i.x, i.y));
                        var o = i.$canvasRenderBuffer.surface;
                        i.dirtyRender && (t.WebGLUtils.deleteWebGLTexture(o), i.$canvasRenderer.renderGraphics(i, i.$canvasRenderBuffer.context, n)), r.drawImage(o, 0, 0, a, s, 0, 0, a, s, o.width, o.height), (i.x || i.y) && (i.dirtyRender && i.$canvasRenderBuffer.context.translate(i.x, i.y), r.transform(1, 0, 0, 1, -i.x, -i.y)), i.dirtyRender = !1
                    }
                    ...
                    var r = n.pop();
                    return r ? r.resize(e, i, !0) : (r = new t.WebGLRenderBuffer(e, i), r.$computeDrawCall = !1), r
                }, a
            }();
