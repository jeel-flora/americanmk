/*! howler.js v2.0.1 | (c) 2013-2016, James Simpson of GoldFire Studios | MIT License | howlerjs.com */ ! function() {
    "use strict";
    var e = function() {
        this.init()
    };
    ...
    o.prototype = {
            ...
            for (var t = o._getSoundIds(e), r = 0; r < t.length; r++) {
                ...
                if (a && (a._seek = a._start || 0, a._rateSeek = 0, a._paused = !0, a._ended = !0, o._stopFade(t[r]), a._node))
                    if (o._webAudio) {
                        ...
                        "undefined" == typeof a._node.bufferSource.stop ? a._node.bufferSource.noteOff(0) : a._node.bufferSource.stop(0), o._cleanBuffer(a._node)
        ...
        fade: function(e, o, t, r) {
            var a = this,
                ...
                i = u / .01,
                _ = i > 0 ? t / i : t;
            if (_ < 4 && (i = Math.ceil(i / (4 / _)), _ = 4), "loaded" !== a._state) return a._queue.push({
                event: "fade",
                action: function() {
                    a.fade(e, o, t, r)
                }
            ...
            for (var s = a._getSoundIds(r), l = 0; l < s.length; l++) {
                ...
                if (f) {
                    if (r || a._stopFade(s[l]), a._webAudio && !f._muted) {
                    ...
                    f._interval = setInterval(function(e, n) {
                        i > 0 && (m += "in" === d ? .01 : -.01), m = Math.max(0, m), m = Math.min(1, m), m = Math.round(100 * m) / 100, a._webAudio ? ("undefined" == typeof r && (a._volume = m), n._volume = m) : a.volume(m, e, !0), m === o && (clearInterval(n._interval), n._interval = null, a.volume(m, e), a._emit("fade", e))
                    }.bind(a, s[l], f), _)
                }
            }
            return a
        ...
        loop: function() {
            ...
            for (var a = t._getSoundIds(n), u = 0; u < a.length; u++) o = t._soundById(a[u]), o && (o._loop = e, t._webAudio && o._node && o._node.bufferSource && (o._node.bufferSource.loop = e, e && (o._node.bufferSource.loopStart = o._start || 0, o._node.bufferSource.loopEnd = o._stop)));
            return t
        },
        rate: function() {
            var e, o, t = this,
    ...
    var r = {},
        ...
        _ = function() {
            ...
            if (o && r && r < 9) {
                var a = /safari/.test(n._navigator && n._navigator.userAgent.toLowerCase());
                (n._navigator && n._navigator.standalone && !a || n._navigator && !n._navigator.standalone && !a) && (n.usingWebAudio = !1)
            }
