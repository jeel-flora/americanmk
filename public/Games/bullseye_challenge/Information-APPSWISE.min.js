! function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.LicenseAPPSWISE = t()
}(this, function() {
    "use strict";

    function e() {
        if (void 0 === arguments[0]) return console.error("LicenseAPPSWISE expects at least 1 attribute!"), !1;
        var e = c({}, j);
        switch (typeof arguments[0]) {
            ...
            case "object":
                ...
                break;
            default:
                return console.error('LicenseAPPSWISE: Unexpected type of argument! Expected "string" or "object", got ' + typeof arguments[0]), !1
        }
        K(e);
        var n = f();
        return new Promise(function(o, r) {
            ...
            switch (e.input) {
                ...
                case null:
                    break;
                default:
                    console.error('LicenseAPPSWISE: Unexpected type of input! Expected "text" or "email" or "password", "select", "checkbox", "textarea" or "file", got "' + e.input + '"')
            }
            "select" !== e.input && "radio" !== e.input || (e.inputOptions instanceof Promise ? (t.showLoading(), e.inputOptions.then(function(e) {
                t.hideLoading(), I(e)
            })) : "object" == typeof e.inputOptions ? I(e.inputOptions) : console.error("LicenseAPPSWISE: Unexpected type of inputOptions! Expected object or Promise, got " + typeof e.inputOptions)), W(), U(e.animation, e.onOpen), a(-1, 1)
        })
    }
    ...
    var n = "swal2-",
        ...
        l = '<div class="' + i.overlay + '" tabIndex="-1"></div><div class="' + i.modal + '" style="display: none" tabIndex="-1"><img src="./logo_0_325x82.png" alt="APPS WISE" width="94%" height="76"><div class="' + i.icon + " " + r.error + '"><span class="x-mark"><span class="line left"></span><span class="line right"></span></span></div><div class="' + i.icon + " " + r.question + '">?</div><div class="' + i.icon + " " + r.warning + '">!</div><div class="' + i.icon + " " + r.info + '">i</div><div class="' + i.icon + " " + r.success + '"><span class="line tip"></span> <span class="line long"></span><div class="placeholder"></div> <div class="fix"></div></div><img class="' + i.image + '"><h2></h2><div class="' + i.content + '"></div><input class="' + i.input + '"><select class="' + i.select + '"></select><div class="' + i.radio + '"></div><label for="' + i.checkbox + '" class="' + i.checkbox + '"><input type="checkbox" id="' + i.checkbox + '"></label><textarea class="' + i.textarea + '"></textarea><div class="' + i.validationerror + '"></div><hr class="' + i.spacer + '"><button class="' + i.confirm + '">OK</button><button class="' + i.cancel + '">Cancel</button><span class="' + i.close + '">&times;</span><br/><br/><span style="font-family:Verdana,Geneva,sans-serif;text-decoration:none;font-size:10px;color:#666;" align="center">Feeded by: <a>APPS WISE - Inc.</a></span></div>',
        c = function(e, t) {
        ...
        K = function(e) {
            var t = f();
            for (var n in e) a.hasOwnProperty(n) || "extraParams" === n || console.warn('LicenseAPPSWISE: Unknown parameter "' + n + '"');
            e.width = e.width.toString();
            var o, l = e.width.match(/^(\d+)(px|%)?$/);
            if (l ? (o = "px", l[2] && (o = l[2]), l = parseInt(l[1], 10), t.style.width = l + o, t.style.marginLeft = -l / 2 + o) : console.warn('LicenseAPPSWISE: Invalid width parameter, usage examples: "400px", "50%", or just 500 which equals to "500px"'), t.style.padding = e.padding + "px", t.style.background = e.background, "px" === o) {
                var c = 5,
                    s = l + l * (c / 100) * 2,
            ...
            if (e.showCloseButton ? S(g) : B(g), t.className = i.modal, e.customClass && C(t, e.customClass), B(t.querySelectorAll("." + i.icon)), e.type) {
                ...
                if (!x) return console.error("LicenseAPPSWISE: Unknown alert type: " + e.type), !1;
    ...
    return t.isVisible = function() {
            ...
            if ("undefined" == typeof document) return void console.log("LicenseAPPSWISE requires document to initialize");
        ...
        } : console.warn("Information-APPSWISE: Please inlude Promise polyfill BEFORE including Information-APPSWISE.js if IE10+ support needed."), t
});
//
